...
/* JSON-Objekte */
var webtechJSON = JSON.parse(loadPage("/../team42/Meilenstein 2-3/json/webtech.json"));

var conhitJSON = JSON.parse(loadPage("/../team42/Meilenstein 2-3/json/conhit.json"));

var cebitJSON = JSON.parse(loadPage("/../team42/Meilenstein 2-3/json/cebit.json"));

var kostenJSON = JSON.parse(loadPage("/../team42/Meilenstein 2-3/json/kosten.json"));
